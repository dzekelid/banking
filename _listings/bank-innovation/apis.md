...
description: 'Visa doesnt see much use for blockchain in its core business, which
  ...
  Media and Communications conference in Boston yesterday, Kelly said: Remember blockchain
  actually ...'
...
- type: x-blog-rss
  url: http://www.bankinnovation.net/feed/
- type: x-crunchbase
  url: https://crunchbase.com/organization/bank-innovation
- type: x-twitter
  url: https://twitter.com/bankinnovation
- type: x-website
  url: http://www.bankinnovation.net/
include: []
maintainers:
- FN: Kin Lane
